...
SYSTEM_POSITIVE_MIN = 30
AI_POSITIVE_MIN = 30
AI_ANALYZE_SYSTEM_MIN = 20
SYMBOL_AI_MAX_ARTICLES = 20
...
DAILY_REVIEWS_FILE = DATA_DIR / "daily_ai_reviews.json"
IMPROVEMENTS_FILE = DATA_DIR / "improvement_registry.json"
EXPORT_HISTORY_FILE = DATA_DIR / "development_exports.json"
